...
displ_cmd = '/opt/homebrew/bin/displayplacer'
standing = 'B7C4E432-5F60-47F4-93EE-583CA59C8A74'
sitting = '92A62516-4A5E-49C9-BD3A-3BCA692E539A'

arrangement_query = [displ_cmd,"list"]

def print_exc(msg):
	'''Print standard out/standard error.'''
...
if current_primary_display == standing:
	switch_cmd = f'{displ_cmd} "id:{standing} res:2560x1440 scaling:off origin:(0,0) degree:0" "id:{sitting} res:2560x1440 scaling:off origin:(2560,0) degree:0"'
else:
	switch_cmd = f'{displ_cmd} "id:{sitting} res:2560x1440 scaling:off origin:(0,0) degree:0" "id:{standing} res:2560x1440 scaling:off origin:(-2560,0) degree:0"'
